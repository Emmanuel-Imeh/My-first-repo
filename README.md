...
## Welcome to my page 
## About Page 
Initial Responsive Page structured with Hypertext Markup Language, Cascading Style Sheet and Javascript.     

This page is structured on Visual Studio Code Integrated Developement Environment.

<hr>  

##### To open the page:  
```html
<button onclick="loadPage()" class="button-to-open button-bg button-size">Open Galary</button>
```
